  ...
  return (
    <header className="flex w-full items-center justify-between px-6 py-6 sm:px-10">
      ...
      <div className="flex items-center gap-2">
        <button onClick={onToggleAudio} aria-label={audioLabel} className={`flex h-9 w-9 items-center justify-center rounded-full border transition-colors ${isSpeaking ? 'border-ember text-ember bg-ember/10' : 'border-border text-foreground/80 hover:border-ember hover:text-ember'}`}>
